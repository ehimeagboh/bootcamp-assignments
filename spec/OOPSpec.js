describe('NotesApplication', function() {
    ...
    describe('note formatter', function() {
        ...
        it('lists notes by id', function() {
            expect(listNotes(0, 'Buy milk')).toEqual(console.log('Note ID:\
             ' + note_id + '\n' + 'Buy milk' + '\n' + '\n' + '\n' + 'By Author ' + author));
        });
    });
    describe('search notes', function() {
        ...
        it('can find notes by id', function() {
            expect(get(note_id)).toEqual(console.log('Note ID:\
             ' + note_id + '\n' + note_content + '\n' + '\n' + '\n' + 'By Author ' + author));
        });
        it('can find notes by content', function() {
            expect(search(search_text)).toEqual(console.log('Showing results for search\
             ' + search_text + '\n' + '\n' + 'Note ID:\
              ' + note_id + '\n' + note_content + '\n' + '\n' + '\n' + 'By Author ' + author));
        });
